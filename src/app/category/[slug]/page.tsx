    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 lg:mt-10 space-y-12">
      <div>
        <div className="flex flex-col sm:flex-row justify-between sm:items-end mb-8 gap-4">
          <h1 className="text-4xl lg:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 inline-block drop-shadow-md m-0">
            {title}
          </h1>
          <RefreshButton />
        </div>
